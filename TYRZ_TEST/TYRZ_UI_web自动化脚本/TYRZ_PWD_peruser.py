...
driver.get("http://61.190.70.197:8800/uccp-user/resources/forgetPsd/forgetPsd-phone")
driver.maximize_window()
#sreach_windows = driver.current_window_handle
'''第一个填写登陆账号界面'''
time.sleep(2)
driver.find_element_by_xpath('//*[@id="forget-step1"]/div[1]/div/span[1]/span/input').send_keys('342601199406200214')
n = input ("请输入图形验证码:")
...
a = input ("请输入短信验证码")
driver.find_element_by_xpath('//*[@id="phoneIsNull"]/div[1]/div[2]/div/div[1]/span/span/input').send_keys(a)
time.sleep(2)
